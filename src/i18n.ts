...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'templates.import': { en: 'Import Template', tr: 'Şablon İçe Aktar' },
  'templates.export': { en: 'Export', tr: 'Dışa Aktar' },
  'templates.edit': { en: 'Edit', tr: 'Düzenle' },
  'templates.delete': { en: 'Delete', tr: 'Sil' },
  'templates.custom': { en: 'Custom', tr: 'Özel' },
  'templates.viewAll': { en: 'All Templates', tr: 'Tüm Şablonlar' },
  'templates.viewByCategory': { en: 'By Category', tr: 'Kategoriye Göre' },
  'templates.selectCategory': { en: 'Select a Category', tr: 'Bir Kategori Seçin' },
  
  // Template Ratings
  'templates.rate': { en: 'Rate', tr: 'Değerlendir' },
  'templates.rateTemplate': { en: 'Rate this Template', tr: 'Bu Şablonu Değerlendir' },
  'templates.yourRating': { en: 'Your Rating', tr: 'Değerlendirmeniz' },
  'templates.yourReview': { en: 'Your Review', tr: 'Yorumunuz' },
  'templates.optional': { en: 'optional', tr: 'isteğe bağlı' },
  'templates.reviewPlaceholder': { en: 'Share your experience with this template...', tr: 'Bu şablon hakkındaki deneyiminizi paylaşın...' },
  'templates.submitRating': { en: 'Submit Rating', tr: 'Değerlendirmeyi Gönder' },
  'templates.selectRating': { en: 'Please select a rating', tr: 'Lütfen bir değerlendirme seçin' },
  'templates.reviews': { en: 'reviews', tr: 'değerlendirme' },
  
  // AI Suggestions
  'templates.aiSuggestions': { en: 'AI Suggestions', tr: 'YZ Önerileri' },
  'templates.aiRecommendations': { en: 'AI Template Recommendations', tr: 'YZ Şablon Önerileri' },
  'templates.aiDescription': { en: 'Based on your job description, we recommend these templates', tr: 'İş açıklamanıza göre bu şablonları öneriyoruz' },
  'templates.matchReason': { en: 'Why this template', tr: 'Neden bu şablon' },
  'templates.matchedKeywords': { en: 'Matched Keywords', tr: 'Eşleşen Anahtar Kelimeler' },
  
  // Template Customizer
  'templateCustomizer.title': { en: 'Template Customizer', tr: 'Şablon Özelleştirici' },
  'templateCustomizer.description': { en: 'Create your own custom template with personalized colors, fonts, and layout', tr: 'Kişiselleştirilmiş renkler, yazı tipleri ve düzen ile kendi özel şablonunuzu oluşturun' },
  'templateCustomizer.basicInfo': { en: 'Basic Information', tr: 'Temel Bilgiler' },
  'templateCustomizer.templateName': { en: 'Template Name', tr: 'Şablon Adı' },
  'templateCustomizer.emoji': { en: 'Icon (Emoji)', tr: 'İkon (Emoji)' },
  'templateCustomizer.colors': { en: 'Colors', tr: 'Renkler' },
  'templateCustomizer.primaryColor': { en: 'Primary Color', tr: 'Ana Renk' },
  'templateCustomizer.secondaryColor': { en: 'Secondary Color', tr: 'İkincil Renk' },
  'templateCustomizer.accentColor': { en: 'Accent Color', tr: 'Vurgu Rengi' },
  'templateCustomizer.textColor': { en: 'Text Color', tr: 'Metin Rengi' },
  'templateCustomizer.backgroundColor': { en: 'Background Color', tr: 'Arka Plan Rengi' },
  'templateCustomizer.fonts': { en: 'Fonts', tr: 'Yazı Tipleri' },
  'templateCustomizer.headingFont': { en: 'Heading Font', tr: 'Başlık Yazı Tipi' },
  'templateCustomizer.bodyFont': { en: 'Body Font', tr: 'Gövde Yazı Tipi' },
  'templateCustomizer.layout': { en: 'Layout', tr: 'Düzen' },
  'templateCustomizer.headerAlignment': { en: 'Header Alignment', tr: 'Başlık Hizalaması' },
  'templateCustomizer.columnLayout': { en: 'Column Layout', tr: 'Sütun Düzeni' },
  'templateCustomizer.sectionSpacing': { en: 'Section Spacing', tr: 'Bölüm Aralığı' },
  'templateCustomizer.features': { en: 'Features', tr: 'Özellikler' },
  'templateCustomizer.featuresDescription': { en: 'Template Features (comma separated)', tr: 'Şablon Özellikleri (virgülle ayrılmış)' },
  'templateCustomizer.featuresHint': { en: 'Example: ATS-Optimized, Clean Layout, Professional', tr: 'Örnek: ATS Uyumlu, Temiz Düzen, Profesyonel' },
  'templateCustomizer.preview': { en: 'Preview', tr: 'Önizleme' },
