...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'personal.photoBlur': { en: 'Blur', tr: 'Bulanıklık' },
  'personal.photoSharpen': { en: 'Sharpen', tr: 'Keskinleştir' },
  'personal.photoVignette': { en: 'Vignette', tr: 'Vinyet' },
  'personal.photoTemperature': { en: 'Temperature', tr: 'Sıcaklık' },
  'personal.photoExposure': { en: 'Exposure', tr: 'Pozlama' },
  'personal.photoAdvancedFilters': { en: 'Advanced Filters', tr: 'Gelişmiş Filtreler' },
  'personal.photoAITools': { en: 'AI Tools', tr: 'YZ Araçları' },
  'personal.photoBasicFilters': { en: 'Basic Filters', tr: 'Temel Filtreler' },
  'personal.photoAutoEnhance': { en: 'Auto Enhance', tr: 'Otomatik İyileştirme' },
  'personal.photoFaceDetection': { en: 'Face Detection', tr: 'Yüz Algılama' },
  'personal.photoBackgroundBlur': { en: 'Background Blur', tr: 'Arka Plan Bulanıklığı' },
  'personal.photoStyleTransfer': { en: 'Style Transfer', tr: 'Stil Transferi' },
  'personal.photoStyleNone': { en: 'None', tr: 'Yok' },
  'personal.photoStyleArtistic': { en: 'Artistic', tr: 'Sanatsal' },
  'personal.photoStyleVintage': { en: 'Vintage', tr: 'Vintage' },
  'personal.photoStyleModern': { en: 'Modern', tr: 'Modern' },
  'personal.photoStyleDramatic': { en: 'Dramatic', tr: 'Dramatik' },
  'personal.photoPresets': { en: 'Presets', tr: 'Ön Ayarlar' },
  'personal.photoPresetWarm': { en: 'Warm', tr: 'Sıcak' },
  'personal.photoPresetCool': { en: 'Cool', tr: 'Soğuk' },
  'personal.photoPresetDramatic': { en: 'Dramatic', tr: 'Dramatik' },
  'personal.photoPresetSoft': { en: 'Soft', tr: 'Yumuşak' },
  'personal.photoComparisonView': { en: 'Compare', tr: 'Karşılaştır' },
  'personal.photoBulkExport': { en: 'Bulk Export', tr: 'Toplu Dışa Aktarım' },
  'personal.photoApplyToAll': { en: 'Apply to All', tr: 'Tümüne Uygula' },
  'personal.photoCloudSync': { en: 'Cloud Sync', tr: 'Bulut Senkronizasyonu' },
  'personal.photoSaveToCloud': { en: 'Save to Cloud', tr: 'Buluta Kaydet' },
  'personal.photoSyncStatus': { en: 'Sync Status', tr: 'Senkronizasyon Durumu' },
  'personal.photoShareLibrary': { en: 'Share Library', tr: 'Kütüphaneyi Paylaş' },
  ...
  // Advanced Cover Letter Features
  'advancedCoverLetter.title': { en: 'Advanced Cover Letter Settings', tr: 'Gelişmiş Niyet Mektubu Ayarları' },
  'advancedCoverLetter.language': { en: 'Language', tr: 'Dil' },
  'advancedCoverLetter.industry': { en: 'Industry', tr: 'Sektör' },
  'advancedCoverLetter.tone': { en: 'Tone', tr: 'Ton' },
  'advancedCoverLetter.emphasizeQuantification': { en: 'Emphasize achievements with numbers', tr: 'Sayılarla başarıları vurgula' },
  'advancedCoverLetter.includeCallToAction': { en: 'Include call to action', tr: 'Harekete geçirici mesaj ekle' },
  'advancedCoverLetter.maxLength': { en: 'Maximum length (words)', tr: 'Maksimum uzunluk (kelime)' },
  'advancedCoverLetter.maxLengthHint': { en: 'Recommended: 250-400 words', tr: 'Önerilen: 250-400 kelime' },
  'advancedCoverLetter.addCompanyResearch': { en: 'Add company research', tr: 'Şirket araştırması ekle' },
  'advancedCoverLetter.companyResearchTitle': { en: 'Company Research', tr: 'Şirket Araştırması' },
  'advancedCoverLetter.companyName': { en: 'Company Name', tr: 'Şirket Adı' },
  'advancedCoverLetter.companyNamePlaceholder': { en: 'e.g., Microsoft', tr: 'örn., Microsoft' },
  'advancedCoverLetter.companyIndustry': { en: 'Industry', tr: 'Sektör' },
  'advancedCoverLetter.companyIndustryPlaceholder': { en: 'e.g., Technology', tr: 'örn., Teknoloji' },
  'advancedCoverLetter.companySize': { en: 'Company Size', tr: 'Şirket Büyüklüğü' },
  'advancedCoverLetter.companySizeSelect': { en: 'Select size...', tr: 'Büyüklük seçin...' },
  'advancedCoverLetter.companySizeStartup': { en: 'Startup (1-50)', tr: 'Startup (1-50)' },
  'advancedCoverLetter.companySizeSmall': { en: 'Small (51-200)', tr: 'Küçük (51-200)' },
  'advancedCoverLetter.companySizeMedium': { en: 'Medium (201-1000)', tr: 'Orta (201-1000)' },
  'advancedCoverLetter.companySizeLarge': { en: 'Large (1001-5000)', tr: 'Büyük (1001-5000)' },
  'advancedCoverLetter.companySizeEnterprise': { en: 'Enterprise (5000+)', tr: 'Kurumsal (5000+)' },
  'advancedCoverLetter.companyCulture': { en: 'Company Culture', tr: 'Şirket Kültürü' },
  'advancedCoverLetter.companyCultureSelect': { en: 'Select culture...', tr: 'Kültür seçin...' },
  'advancedCoverLetter.companyCultureCorporate': { en: 'Corporate', tr: 'Kurumsal' },
  'advancedCoverLetter.companyCultureStartup': { en: 'Startup', tr: 'Startup' },
  'advancedCoverLetter.companyCultureCreative': { en: 'Creative', tr: 'Yaratıcı' },
  'advancedCoverLetter.companyCultureTraditional': { en: 'Traditional', tr: 'Geleneksel' },
  'advancedCoverLetter.companyCultureInnovative': { en: 'Innovative', tr: 'Yenilikçi' },
  'advancedCoverLetter.companyCultureCasual': { en: 'Casual', tr: 'Rahat' },
  'advancedCoverLetter.companyCultureRemote': { en: 'Remote-first', tr: 'Uzaktan çalışma odaklı' },
  'advancedCoverLetter.companyValues': { en: 'Company Values', tr: 'Şirket Değerleri' },
  'advancedCoverLetter.companyValuesPlaceholder': { en: 'e.g., Innovation, Teamwork, Excellence', tr: 'örn., Yenilikçilik, Takım Çalışması, Mükemmellik' },
  'advancedCoverLetter.companyValuesHint': { en: 'Separate values with commas', tr: 'Değerleri virgülle ayırın' },
  'advancedCoverLetter.companyProducts': { en: 'Key Products/Services', tr: 'Ana Ürünler/Hizmetler' },
  'advancedCoverLetter.companyProductsPlaceholder': { en: 'e.g., Cloud Services, AI Solutions', tr: 'örn., Bulut Hizmetleri, YZ Çözümleri' },

  // Industry Types
  'advancedCoverLetter.industryGeneral': { en: 'General', tr: 'Genel' },
  'advancedCoverLetter.industryTechnology': { en: 'Technology', tr: 'Teknoloji' },
  'advancedCoverLetter.industryFinance': { en: 'Finance', tr: 'Finans' },
  'advancedCoverLetter.industryHealthcare': { en: 'Healthcare', tr: 'Sağlık' },
  'advancedCoverLetter.industryEducation': { en: 'Education', tr: 'Eğitim' },
  'advancedCoverLetter.industryMarketing': { en: 'Marketing', tr: 'Pazarlama' },
  'advancedCoverLetter.industryConsulting': { en: 'Consulting', tr: 'Danışmanlık' },
  'advancedCoverLetter.industryManufacturing': { en: 'Manufacturing', tr: 'İmalat' },
  'advancedCoverLetter.industryRetail': { en: 'Retail', tr: 'Perakende' },
  'advancedCoverLetter.industryHospitality': { en: 'Hospitality', tr: 'Konaklama' },
  'advancedCoverLetter.industryLegal': { en: 'Legal', tr: 'Hukuk' },
  'advancedCoverLetter.industryNonprofit': { en: 'Non-profit', tr: 'Kar Amacı Gütmeyen' },
  'advancedCoverLetter.industryGovernment': { en: 'Government', tr: 'Kamu' },
  'advancedCoverLetter.industryMedia': { en: 'Media', tr: 'Medya' },
  'advancedCoverLetter.industryRealEstate': { en: 'Real Estate', tr: 'Gayrimenkul' },
  'advancedCoverLetter.industryAutomotive': { en: 'Automotive', tr: 'Otomotiv' },

  // Tone Types
  'advancedCoverLetter.toneFormal': { en: 'Formal', tr: 'Resmi' },
  'advancedCoverLetter.toneProfessional': { en: 'Professional', tr: 'Profesyonel' },
  'advancedCoverLetter.toneFriendly': { en: 'Friendly', tr: 'Samimi' },
  'advancedCoverLetter.toneEnthusiastic': { en: 'Enthusiastic', tr: 'Heyecanlı' },
  'advancedCoverLetter.toneConservative': { en: 'Conservative', tr: 'Muhafazakar' },
  'advancedCoverLetter.toneInnovative': { en: 'Innovative', tr: 'Yenilikçi' },
  'advancedCoverLetter.toneAcademic': { en: 'Academic', tr: 'Akademik' },

  // Version A/B Testing
  'advancedCoverLetter.versionsTitle': { en: 'Cover Letter Versions', tr: 'Niyet Mektubu Versiyonları' },
  'advancedCoverLetter.generateVersions': { en: 'Generate Multiple Versions', tr: 'Çoklu Versiyon Oluştur' },
  'advancedCoverLetter.variant.standard': { en: 'Standard', tr: 'Standart' },
  'advancedCoverLetter.variant.brief': { en: 'Brief', tr: 'Kısa' },
  'advancedCoverLetter.variant.detailed': { en: 'Detailed', tr: 'Detaylı' },
  'advancedCoverLetter.variant.creative': { en: 'Creative', tr: 'Yaratıcı' },
  'advancedCoverLetter.qualityScore': { en: 'Quality Score', tr: 'Kalite Skoru' },
  'advancedCoverLetter.words': { en: 'words', tr: 'kelime' },
  'advancedCoverLetter.selected': { en: 'Selected', tr: 'Seçili' },
  'advancedCoverLetter.editVersion': { en: 'Edit Version', tr: 'Versiyonu Düzenle' },
  'advancedCoverLetter.editHint': { en: 'Your edits will help improve future generations', tr: 'Düzenlemeleriniz gelecek nesillerin geliştirilmesine yardımcı olacak' },
  'advancedCoverLetter.showComparison': { en: 'Compare Versions', tr: 'Versiyonları Karşılaştır' },
  'advancedCoverLetter.hideComparison': { en: 'Hide Comparison', tr: 'Karşılaştırmayı Gizle' },
  'advancedCoverLetter.comparisonView': { en: 'Version Comparison', tr: 'Versiyon Karşılaştırması' },

  // Main Cover Letter Actions
  'advancedCoverLetter.openSettings': { en: 'Advanced Settings', tr: 'Gelişmiş Ayarlar' },
  'advancedCoverLetter.generating': { en: 'Generating versions...', tr: 'Versiyonlar oluşturuluyor...' },
};
