...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'googleDrive.setupRequired': { en: 'Google Drive setup is required', tr: 'Google Drive kurulumu gerekli' },
  'googleDrive.setupRequiredDesc': { en: 'The Google Client ID has not been configured yet. Please follow these steps:', tr: 'Google Client ID henüz yapılandırılmadı. Lütfen şu adımları izleyin:' },
  'googleDrive.invalidClientId': { en: 'Invalid Client ID', tr: 'Geçersiz Client ID' },
  'googleDrive.clientIdPlaceholder': { en: 'The Client ID in manifest.json is still set to placeholder value', tr: 'manifest.json içindeki Client ID hala yer tutucu değerde' },
  'googleDrive.badClientIdError': { en: 'OAuth2 error: Bad Client ID. Your Google Client ID might be incorrect or not properly configured.', tr: 'OAuth2 hatası: Geçersiz Client ID. Google Client ID\'niz yanlış veya düzgün yapılandırılmamış olabilir.' },
  'googleDrive.setupGuideTitle': { en: 'Quick Setup Guide', tr: 'Hızlı Kurulum Kılavuzu' },
  'googleDrive.viewFullGuide': { en: 'View Full Setup Guide', tr: 'Tam Kurulum Kılavuzunu Görüntüle' },
  ...
  'googleDrive.solution1': { en: 'Solution: Update manifest.json with correct Client ID from Google Cloud Console', tr: 'Çözüm: manifest.json dosyasını Google Cloud Console\'dan doğru Client ID ile güncelleyin' },
  'googleDrive.issue2': { en: 'Issue: APIs not enabled', tr: 'Sorun: API\'ler etkinleştirilmedi' },
  'googleDrive.solution2': { en: 'Solution: Enable Drive, Docs, Sheets, and Slides APIs in Google Cloud Console', tr: 'Çözüm: Google Cloud Console\'da Drive, Docs, Sheets ve Slides API\'lerini etkinleştirin' },
  'googleDrive.issue3': { en: 'Issue: Access denied', tr: 'Sorun: Erişim engellendi' },
  'googleDrive.solution3': { en: 'Solution: Add your email as a test user in OAuth consent screen', tr: 'Çözüm: OAuth izin ekranında e-postanızı test kullanıcısı olarak ekleyin' },
  ...
  'validation.url.invalid': { en: 'Please enter a valid URL (e.g., https://example.com)', tr: 'Lütfen geçerli bir URL girin (örn. https://example.com)' },
  'validation.url.noProtocol': { en: 'Consider adding https:// at the beginning', tr: 'Başlangıca https:// eklemeyi düşünün' },
  'validation.url.spaces': { en: 'URL cannot contain spaces', tr: 'URL boşluk içeremez' },
  'validation.url.local': { en: 'Local URL detected - ensure this is accessible to employers', tr: 'Yerel URL tespit edildi - işverenlerin erişebileceğinden emin olun' },
  'validation.url.valid': { en: 'Valid URL', tr: 'Geçerli URL' },
  'validation.linkedin.invalid': { en: 'LinkedIn username should be 3-100 characters (letters, numbers, hyphens, underscores)', tr: 'LinkedIn kullanıcı adı 3-100 karakter olmalı (harf, rakam, tire, alt çizgi)' },
  'validation.linkedin.valid': { en: 'Valid LinkedIn username', tr: 'Geçerli LinkedIn kullanıcı adı' },
  'validation.github.invalid': { en: 'GitHub username should be 1-39 characters, alphanumeric and hyphens only', tr: 'GitHub kullanıcı adı 1-39 karakter olmalı, sadece alfanümerik ve tire' },
  'validation.github.consecutive': { en: 'GitHub username cannot contain consecutive hyphens', tr: 'GitHub kullanıcı adı ardışık tire içeremez' },
  'validation.github.valid': { en: 'Valid GitHub username', tr: 'Geçerli GitHub kullanıcı adı' },
  'validation.whatsapp.invalid': { en: 'WhatsApp link should be in format: https://wa.me/1234567890', tr: 'WhatsApp bağlantısı şu formatta olmalı: https://wa.me/1234567890' },
  'validation.whatsapp.protocol': { en: 'WhatsApp link must start with https://', tr: 'WhatsApp bağlantısı https:// ile başlamalı' },
  'validation.whatsapp.valid': { en: 'Valid WhatsApp link', tr: 'Geçerli WhatsApp bağlantısı' },
  'validation.portfolio.social': { en: 'Consider using dedicated LinkedIn/GitHub fields instead', tr: 'Bunun yerine özel LinkedIn/GitHub alanlarını kullanmayı düşünün' },
  ...
  'coverTemplates.classic.desc': { en: 'Traditional business letter format, perfect for corporate positions', tr: 'Kurumsal pozisyonlar için mükemmel, geleneksel iş mektubu formatı' },
  'coverTemplates.modern.desc': { en: 'Clean, contemporary design for tech and innovative companies', tr: 'Teknoloji ve yenilikçi şirketler için temiz, çağdaş tasarım' },
  'coverTemplates.executive.desc': { en: 'Sophisticated format for senior leadership positions', tr: 'Üst düzey yönetici pozisyonları için sofistike format' },
  'coverTemplates.creative.desc': { en: 'Expressive design for creative and design roles', tr: 'Kreatif ve tasarım rolleri için etkileyici tasarım' },
  'coverTemplates.startup.desc': { en: 'Dynamic and energetic format for startup environments', tr: 'Startup ortamları için dinamik ve enerjik format' },
  'coverTemplates.academic.desc': { en: 'Formal academic format for research and faculty positions', tr: 'Araştırma ve akademik kadro pozisyonları için resmi akademik format' },
  ...
  'coverTemplates.feature.personalityShowcase': { en: 'Personality Showcase', tr: 'Kişilik Vitrini' },
  ...
  'coverTemplates.feature.directCommunication': { en: 'Direct Communication', tr: 'Doğrudan İletişim' },
  ...
  'coverTemplates.feature.publicationStandard': { en: 'Publication Standard', tr: 'Yayın Standardı' },
