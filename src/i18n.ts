...
const dict: Record<string, Record<Lang, string>> = {
  ...
  // Error Analytics
  'errorAnalytics.title': { en: 'Error Analytics', tr: 'Hata Analitiği' },
  'errorAnalytics.noErrors': { en: 'No errors recorded. Everything is working smoothly!', tr: 'Kaydedilmiş hata yok. Her şey sorunsuz çalışıyor!' },
  'errorAnalytics.totalErrors': { en: 'Total Errors', tr: 'Toplam Hata' },
  'errorAnalytics.criticalErrors': { en: 'Critical Errors', tr: 'Kritik Hatalar' },
  'errorAnalytics.highErrors': { en: 'High Priority', tr: 'Yüksek Öncelik' },
  'errorAnalytics.errorTypes': { en: 'Error Types', tr: 'Hata Türleri' },
  'errorAnalytics.byType': { en: 'Errors by Type', tr: 'Türe Göre Hatalar' },
  'errorAnalytics.bySeverity': { en: 'Errors by Severity', tr: 'Önem Derecesine Göre Hatalar' },
  'errorAnalytics.filters': { en: 'Filters', tr: 'Filtreler' },
  'errorAnalytics.filterBySeverity': { en: 'Filter by Severity', tr: 'Önem Derecesine Göre Filtrele' },
  'errorAnalytics.filterByType': { en: 'Filter by Type', tr: 'Türe Göre Filtrele' },
  'errorAnalytics.recentErrors': { en: 'Recent Errors', tr: 'Son Hatalar' },
  'errorAnalytics.clearData': { en: 'Clear Error Logs', tr: 'Hata Günlüklerini Temizle' },
  'errorAnalytics.clearConfirm': { en: 'Are you sure you want to clear all error logs?', tr: 'Tüm hata günlüklerini temizlemek istediğinizden emin misiniz?' },
  'errorAnalytics.errorGroups': { en: 'Grouped Errors', tr: 'Gruplanmış Hatalar' },
  'errorAnalytics.groupCount': { en: '{count} occurrences', tr: '{count} kez' },
  'errorAnalytics.firstSeen': { en: 'First seen', tr: 'İlk görülme' },
  'errorAnalytics.lastSeen': { en: 'Last seen', tr: 'Son görülme' },
  'errorAnalytics.errorRate': { en: 'Error Rate', tr: 'Hata Oranı' },
  'errorAnalytics.lastHour': { en: 'Last Hour', tr: 'Son Saat' },
  'errorAnalytics.lastDay': { en: 'Last Day', tr: 'Son Gün' },
  'errorAnalytics.lastWeek': { en: 'Last Week', tr: 'Son Hafta' },
  'errorAnalytics.performanceImpact': { en: 'Performance Impact', tr: 'Performans Etkisi' },
  'errorAnalytics.avgMemory': { en: 'Avg Memory', tr: 'Ort. Bellek' },
  'errorAnalytics.avgLoadTime': { en: 'Avg Load Time', tr: 'Ort. Yükleme' },
  'errorAnalytics.affectedOps': { en: 'Affected Operations', tr: 'Etkilenen İşlemler' },
  'errorAnalytics.breadcrumbs': { en: 'User Actions', tr: 'Kullanıcı İşlemleri' },
  'errorAnalytics.recoverable': { en: 'Recoverable', tr: 'Kurtarılabilir' },
  'errorAnalytics.recoverySuggestion': { en: 'Recovery Suggestion', tr: 'Kurtarma Önerisi' },
  'errorAnalytics.screenshot': { en: 'Screenshot', tr: 'Ekran Görüntüsü' },
  'errorAnalytics.viewScreenshot': { en: 'View Screenshot', tr: 'Ekran Görüntüsünü Gör' },
  'errorAnalytics.noScreenshot': { en: 'No screenshot available', tr: 'Ekran görüntüsü mevcut değil' },
  'errorAnalytics.errorTrends': { en: 'Error Trends', tr: 'Hata Trendleri' },
};
