...
export const DescriptionTemplates: React.FC<DescriptionTemplatesProps> = ({
  ...
  const getTemplates = (): { key: string; label: string }[] => {
    switch (type) {
      ...
      case 'education':
        return [
          {
            key: 'templates.education.coursework',
            label: t(language, 'templates.education.coursework'),
          },
          {
            key: 'templates.education.achievement',
          ...
          {
            key: 'templates.education.activities',
  ...
  return (
    <div className="template-dropdown">
      <button type="button" className="btn btn-secondary btn-sm" onClick={() => setIsOpen(!isOpen)}>
        ...
        <>
          ...
          <div className="template-menu">
            <div className="template-menu-header">
              ...
              <button type="button" className="template-close" onClick={() => setIsOpen(false)}>
                ✕
              </button>
            </div>
