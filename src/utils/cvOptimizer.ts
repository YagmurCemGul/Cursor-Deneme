...
export function getOptimizationPreview(
  ...
  // Check personal info
  if (cvData.personalInfo.summary && cvData.personalInfo.summary.includes(optimization.originalText)) {
    changes.push({
      section: 'Personal Info',
      field: 'Summary',
      before: cvData.personalInfo.summary,
      after: replaceText(cvData.personalInfo.summary, optimization.originalText, optimization.optimizedText)
    });
  }
